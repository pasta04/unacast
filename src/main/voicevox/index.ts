...
class VoiceVoxClient {
  constructor(options?: Options) {
    ...
    if (os.platform() == 'win32') {
      ...
      // のいずれか
      const search_paths = voicevox_path ? [voicevox_path] : [
        path.join(process.env['PROGRAMFILES'] || 'C:\\Program Files', 'VOICEVOX'),
        path.join(os.homedir(), 'AppData\\Local\\Programs\\VOICEVOX'),
      ];
      ...
      const search_paths = voicevox_path ? [voicevox_path] : [
        '/Applications/VOICEVOX/VOICEVOX.app/Contents/MacOS',
        path.join(os.homedir(), '/Applications/VOICEVOX/VOICEVOX.app/Contents/MacOS'),
      ];
